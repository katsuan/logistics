...
var require_yubinbango_core = __commonJS({
  "node_modules/yubinbango-core2/yubinbango-core.js"(exports, module) {
    var CACHE = [];
    var YubinBango;
    (function(YubinBango2) {
      var Core = function() {
        function Core2(inputVal, callback) {
          if (inputVal === void 0) {
            inputVal = "";
          }
        ...
        Core2.prototype.chk7 = function(val) {
          if (val.length === 7) {
            return val;
          }
        };
        Core2.prototype.addrDic = function(region_id, region, locality, street, extended) {
          if (region_id === void 0) {
            region_id = "";
          }
          if (region === void 0) {
        ...
        Core2.prototype.selectAddr = function(addr) {
        ...
        Core2.prototype.jsonp = function(url, fn) {
        ...
        Core2.prototype.getAddr = function(yubin7, fn) {
          var _this = this;
      ...
      YubinBango2.Core = Core;
    })(YubinBango || (YubinBango = {}));
    module.exports = YubinBango;
  }
});
export default require_yubinbango_core();
//# sourceMappingURL=yubinbango-core2.js.map
